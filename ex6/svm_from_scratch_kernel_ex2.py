""" Building an SVM from scratch, including kernel, evaluated on dataset 2 """

"""
Notes)
- dont force matrix shapes to be hypothesis = theta.T, X
- X: (863, 3), y: (863,), theta: (3,)
...
def gradient_descent(theta, inputs, correct, C, learning_rate=0.00001, iterations=1000, decay_term=0.99, old=False):
...
# optimize theta
final_theta = gradient_descent(initial_theta, gaussian_features, y, C=100)
